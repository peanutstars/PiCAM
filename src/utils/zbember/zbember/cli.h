...
/** @brief <b>send_zcl_ip [DestEUI64:8] [sourceEndpoint:1] [destEndpoint:1] </b>
 *   - <i>Send a ZCL message over ZCL-IP</i>
 *     - DestEUI64 - IEEE_ADDRESS - Destination EUI64
 *     - sourceEndpoint - INT8U - sourceEndpoint
 *     - destEndpoint - INT8U - Destination Endpoint
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_BUILD_SEND_MSG_SEND_ZCL_IP
...
/** @addtogroup plugin-find-and-bind Plugin Commands: Find and Bind
 * @ingroup cli
 * Commands for the finding and binding process from the Base Device Behavior
 * spec.
 * 
 * @{
 */

/** @brief <b>plugin find-and-bind target </b>
 *   - <i>Makes this node start identifying as a target for binding with an initiator node.</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_FIND_AND_BIND_PLUGIN_FIND_AND_BIND_TARGET

/** @brief <b>plugin find-and-bind initiator </b>
 *   - <i>Makes this node start the initiator part of the finding and binding process.</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_FIND_AND_BIND_PLUGIN_FIND_AND_BIND_INITIATOR

/** @} */ // end group plugin-find-and-bind
...
/** @brief <b>plugin ota-server upgrade [nodeId:2] [endpoint:1] </b>
 *   - <i>Instruct a device to upgrade now.</i>
 *     - nodeId - INT16U - device id for the image
 *     - endpoint - INT8U - software version for the image
 */
 ...
 *   - <i></i>
 *     - period - INT16U - The minimum request period in milliseconds.
 */
