...
#define EMBER_AF_MESSAGING_CONFIRMATION_CONTROL_N_ORETURNED (0x01)
#define EMBER_AF_MESSAGING_CONFIRMATION_CONTROL_Y_E_SRETURNED (0x02)
#define EMBER_AF_MESSAGING_CONFIRMATION_CONTROL_Y_E_SRETURNED_OFFSET (1)
